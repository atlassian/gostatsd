			...
			"t1": map[string]gostatsd.Timer{
				"tag2": {
					...
					Buckets: map[gostatsd.BucketBounds]int{
						gostatsd.BucketBounds{0, 20}:                             5,
						gostatsd.BucketBounds{20, 30}:                            5,
						gostatsd.BucketBounds{30, 40}:                            0,
						gostatsd.BucketBounds{40, 50}:                            0,
						gostatsd.BucketBounds{50, 60}:                            9,
						gostatsd.BucketBounds{60, statsd.PosInfinityBucketLimit}: 10,
					},
				},
			},
		},
