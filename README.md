...
- `enable-retries`: This will tell the forwarder to attempt to send payloads again in case it failed for the first time, 
   with exponential back off. Defaults to `true`
